...
|    `url`    | String |   Yes    |      -       | A thread's attachment `URL`.                |
| `image_url` | String |   Yes    |      -       | An image's `HTTP(S)` URL or path to a file. |
| `reply_to`  | String |   Yes    |      -       | An identifier of a thread to reply to.      |
